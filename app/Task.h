...
public:
	explicit Task(uint p_taskId = 0, const QString& p_description = QString::null, const QString& p_category = QString::null, const QString& p_assignee = QString::null, QObject* p_parent = nullptr);
